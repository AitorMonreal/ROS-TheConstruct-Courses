...
def calculate_distance(array):
    ...
    x_position_0 = start_odom.pose.pose.position.x
    y_position_0 = start_odom.pose.pose.position.y

    x_position_end = end_odom.pose.pose.position.x
    y_position_end = end_odom.pose.pose.position.y
